...
TOOLSETS = {
    ...
    "hermes-qq": {
        "description": "QQ bot toolset - OneBot bridge messaging on Windows/native deployments",
        "tools": _HERMES_CORE_TOOLS,
        "includes": []
    },
    ...
    "hermes-gateway": {
        ...
        "tools": [],
        "includes": ["hermes-telegram", "hermes-discord", "hermes-whatsapp", "hermes-slack", "hermes-signal", "hermes-homeassistant", "hermes-email", "hermes-sms", "hermes-mattermost", "hermes-matrix", "hermes-dingtalk", "hermes-qq", "hermes-feishu", "hermes-wecom", "hermes-webhook"]
    }
}
